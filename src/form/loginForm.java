...
public class loginForm extends javax.swing.JFrame {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        try {
            ...
            Pharmacist p = Communication.getInstance().login(username, password);
            JOptionPane.showMessageDialog(this, "Login success. Welcome " + p.getName());
            MySession.getInstance().addValue("logged_pharmacist", p);
